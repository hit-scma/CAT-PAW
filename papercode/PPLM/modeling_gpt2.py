...
from transformers.file_utils import cached_path, CONFIG_NAME, WEIGHTS_NAME
...
class Attention(nn.Module):
    ...
    def forward(self, x, layer_past=None):
        ...
        present = torch.stack((key.transpose(-2, -1), value))  # transpose to have same shapes for stacking #(stack_dim, batch, head, seq_length, head_features)
